...
**This is a fork of [jonasmerlin/react-native-markdown-display](https://github.com/jonasmerlin/react-native-markdown-display) that itself is a fork of [iamacup/react-native-markdown-display](https://github.com/iamacup/react-native-markdown-display). This is used for our own React Native application for rendering rich text. It may be of some use to you too!**
